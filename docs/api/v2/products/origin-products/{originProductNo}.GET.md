---
doc-id: "v2-products-origin-products-originProductNo-get"
title: "(v2) 원상품 조회"
description: "원상품을 조회합니다."
type: api-endpoint
method: GET
...
```
> **GET** `https://api.commerce.naver.com/external/v2/products/origin-products/{originProductNo}`
```
...
**GET** `/v2/products/origin-products/{originProductNo}` — 응답
성공
...
해당 카탈로그 ID 기준으로 [카탈로그 단건 조회](../../../v1/product-models/{id}.GET.md)에서 상세 정보를 조회할 수 있습니다.
