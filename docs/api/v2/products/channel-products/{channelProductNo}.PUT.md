---
doc-id: "v2-products-channel-products-channelProductNo-put"
title: "(v2) 채널 상품 수정"
...
```
> **PUT** `https://api.commerce.naver.com/external/v2/products/channel-products/{channelProductNo}`
```
...
**PUT** `/v2/products/channel-products/{channelProductNo}` — 응답
성공
