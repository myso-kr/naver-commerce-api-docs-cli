---
doc-id: "v2-standard-group-products-groupProductNo-get"
title: "(v2) 그룹상품 조회"
description: "그룹상품을 조회합니다."
type: api-endpoint
method: GET
...
status: stable
updated: "2026-03-12"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/read-product-product
---
...
```
> **GET** `https://api.commerce.naver.com/external/v2/standard-group-products/{groupProductNo}`
```
...
**GET** `/v2/standard-group-products/{groupProductNo}` — 응답
성공
