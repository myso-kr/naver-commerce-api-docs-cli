---
doc-id: "v2-standard-group-products-status-get"
title: "(v2) 그룹상품 요청 결과 조회"
description: "그룹상품 등록 API와 그룹상품 수정 API의 요청 결과를 조회합니다. - type : CREATE(등록), UPDATE(수정)"
type: api-endpoint
method: GET
...
```
> **GET** `https://api.commerce.naver.com/external/v2/standard-group-products/status`
```
...
**GET** `/v2/standard-group-products/status` — 응답
성공
