---
doc-id: "v1-pay-order-seller-orders-orderId-product-order-ids-get"
title: "상품 주문 목록 조회"
description: "주문에 대한 상품 주문 번호 목록을 조회합니다."
type: api-endpoint
method: GET
...
```
> **GET** `https://api.commerce.naver.com/external/v1/pay-order/seller/orders/{orderId}/product-order-ids`
```
...
**Example:** 2021123115350911

## Responses

**GET** `/v1/pay-order/seller/orders/{orderId}/product-order-ids` — 응답
(성공) 상품 주문 번호
