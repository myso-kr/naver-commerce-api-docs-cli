---
doc-id: "v1-pay-order-seller-product-orders-confirm-post"
title: "발주 확인 처리"
...
keywords:
  ...
  - "confirm"
  - "v1 pay-order seller product-orders confirm"
  - "product-orders confirm"
  - "pay-order seller product-orders confirm"
  - "seller-confirm-placed-product-orders-pay-order-seller"
  - "placed"
  - "product"
  - "products"
  - "상품"
...
**POST** `/v1/pay-order/seller/product-orders/confirm` — 응답
(성공/실패) 상품 주문 처리 내역
...
```bash
curl -L 'https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/confirm' \
