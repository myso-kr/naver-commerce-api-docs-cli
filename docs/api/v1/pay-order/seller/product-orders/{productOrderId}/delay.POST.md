---
doc-id: "v1-pay-order-seller-product-orders-productOrderId-delay-post"
title: "발송 지연 처리"
...
```
> **POST** `https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/{productOrderId}/delay`
```
...
**POST** `/v1/pay-order/seller/product-orders/{productOrderId}/delay` — 응답
(성공/실패) 상품 주문 처리 내역
