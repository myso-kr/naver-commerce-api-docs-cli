---
doc-id: "v1-pay-order-seller-product-orders-productOrderId-claim-exchange-reject-post"
title: "교환 거부(철회)"
description: "1건의 상품 주문에 대한 교환 요청을 거부(철회)합니다."
type: api-endpoint
method: POST
...
keywords:
  ...
  - "v1 pay-order seller product-orders productorderid claim exchange reject"
  - "exchange reject"
  - "pay-order seller product-orders productorderid claim exchange reject"
  - "seller-reject-exchange-pay-order-seller"
  - "pay"
status: stable
updated: "2026-03-13"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/seller-reject-exchange-pay-order-seller
---
...
```
> **POST** `https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/{productOrderId}/claim/exchange/reject`
```
...
교환 요청 거부(철회) Request Object

**rejectExchangeReason**stringrequired

교환 거부(철회) 사유

**Example:** `착용한 상품은 교환할 수 없습니다.`

## Responses

**POST** `/v1/pay-order/seller/product-orders/{productOrderId}/claim/exchange/reject` — 응답
(성공/실패) 상품 주문 처리 내역
...
```bash
curl -L 'https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/:productOrderId/claim/exchange/reject' \
