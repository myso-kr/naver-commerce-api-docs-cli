---
doc-id: "v1-pay-order-seller-product-orders-productOrderId-claim-return-reject-post"
title: "반품 거부(철회)"
description: "1건의 상품 주문에 대한 반품 요청을 거부(철회)합니다."
type: api-endpoint
method: POST
...
```
> **POST** `https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/{productOrderId}/claim/return/reject`
```
...
반품 요청 거부(철회) Request Object

**rejectReturnReason**stringrequired

반품 거부(철회) 사유

**Example:** `고객님께서 통화로 교환을 원하셨습니다.`

## Responses

**POST** `/v1/pay-order/seller/product-orders/{productOrderId}/claim/return/reject` — 응답
(성공/실패) 상품 주문 처리 내역
...
```bash
curl -L 'https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/:productOrderId/claim/return/reject' \
-H 'Content-Type: application/json' \
-H 'Accept: application/json' \
-H 'Authorization: Bearer <token>' \
-d '{
  "rejectReturnReason": "고객님께서 통화로 교환을 원하셨습니다."
}'
```
