---
doc-id: "v1-pay-order-seller-product-orders-productOrderId-claim-exchange-holdback-post"
title: "교환 보류"
description: "1건의 상품 주문에 대한 교환을 보류합니다."
type: api-endpoint
method: POST
...
```
> **POST** `https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/{productOrderId}/claim/exchange/holdback`
```
...
**POST** `/v1/pay-order/seller/product-orders/{productOrderId}/claim/exchange/holdback` — 응답
(성공/실패) 상품 주문 처리 내역
