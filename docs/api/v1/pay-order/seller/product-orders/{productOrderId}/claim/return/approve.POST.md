---
doc-id: "v1-pay-order-seller-product-orders-productOrderId-claim-return-approve-post"
title: "반품 승인"
description: "1건의 상품 주문에 대한 반품 요청을 승인합니다."
type: api-endpoint
method: POST
...
keywords:
  ...
  - "v1 pay-order seller product-orders productorderid claim return approve"
  - "return approve"
  - "pay-order seller product-orders productorderid claim return approve"
  - "seller-approve-return-pay-order-seller"
  - "pay"
status: stable
updated: "2026-03-13"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/seller-approve-return-pay-order-seller
---
...
```
> **POST** `https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/{productOrderId}/claim/return/approve`
```
...
**POST** `/v1/pay-order/seller/product-orders/{productOrderId}/claim/return/approve` — 응답
(성공/실패) 상품 주문 처리 내역
...
```bash
curl -L -X POST 'https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/:productOrderId/claim/return/approve' \
