---
doc-id: "v1-pay-order-seller-product-orders-productOrderId-claim-exchange-dispatch-post"
title: "교환 재배송 처리"
description: "1건의 상품 주문 교환 승인 건을 재배송 처리합니다."
type: api-endpoint
method: POST
...
```
> **POST** `https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/{productOrderId}/claim/exchange/dispatch`
```
...
**POST** `/v1/pay-order/seller/product-orders/{productOrderId}/claim/exchange/dispatch` — 응답
(성공/실패) 상품 주문 처리 내역
...
```bash
curl -L 'https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/:productOrderId/claim/exchange/dispatch' \
