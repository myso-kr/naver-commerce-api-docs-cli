---
doc-id: "v1-pay-order-seller-product-orders-productOrderId-claim-cancel-request-post"
title: "취소 요청"
description: "1건의 상품 주문을 취소 요청합니다."
type: api-endpoint
method: POST
...
keywords:
  ...
  - "v1 pay-order seller product-orders productorderid claim cancel request"
  - "cancel request"
  - "pay-order seller product-orders productorderid claim cancel request"
  - "seller-request-cancel-pay-order-seller"
  - "pay"
status: stable
updated: "2026-03-13"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/seller-request-cancel-pay-order-seller
---
...
```
> **POST** `https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/{productOrderId}/claim/cancel/request`
```
...
취소 요청 Request Object

**cancelReason**requestCancelClaimReason.pay-order-seller (string)required
...
**POST** `/v1/pay-order/seller/product-orders/{productOrderId}/claim/cancel/request` — 응답
(성공/실패) 상품 주문 처리 내역
...
```bash
curl -L 'https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/:productOrderId/claim/cancel/request' \
