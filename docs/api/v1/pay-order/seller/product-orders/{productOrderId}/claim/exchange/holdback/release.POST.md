---
doc-id: "v1-pay-order-seller-product-orders-productOrderId-claim-exchange-holdback-release-post"
title: "교환 보류 해제"
description: "1건의 상품 주문에 대한 교환 보류를 해제합니다."
type: api-endpoint
method: POST
...
keywords:
  ...
  - "v1 pay-order seller product-orders productorderid claim exchange holdback release"
  - "holdback release"
  - "pay-order seller product-orders productorderid claim exchange holdback release"
  - "seller-release-exchange-holdback-pay-order-seller"
  - "pay"
status: stable
updated: "2026-03-13"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/seller-release-exchange-holdback-pay-order-seller
---
...
```
> **POST** `https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/{productOrderId}/claim/exchange/holdback/release`
```
...
**POST** `/v1/pay-order/seller/product-orders/{productOrderId}/claim/exchange/holdback/release` — 응답
(성공/실패) 상품 주문 처리 내역
...
```bash
curl -L -X POST 'https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/:productOrderId/claim/exchange/holdback/release' \
