---
doc-id: "v1-pay-order-seller-product-orders-productOrderId-claim-return-request-post"
title: "반품 요청"
description: "1건의 상품 주문에 대해 반품 요청합니다."
type: api-endpoint
method: POST
...
```
> **POST** `https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/{productOrderId}/claim/return/request`
```
...
**POST** `/v1/pay-order/seller/product-orders/{productOrderId}/claim/return/request` — 응답
(성공/실패) 상품 주문 처리 내역
