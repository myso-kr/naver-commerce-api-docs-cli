---
doc-id: "v1-pay-order-seller-product-orders-productOrderId-claim-exchange-collect-approve-post"
title: "교환 수거 완료"
description: "1건의 상품 주문에 대한 교환을 수거 완료 처리합니다."
type: api-endpoint
method: POST
...
keywords:
  ...
  - "v1 pay-order seller product-orders productorderid claim exchange collect approve"
  - "collect approve"
  - "pay-order seller product-orders productorderid claim exchange collect approve"
  - "seller-approve-collected-exchange-pay-order-seller"
  - "collected"
  - "pay"
status: stable
updated: "2026-03-13"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/seller-approve-collected-exchange-pay-order-seller
---
...
```
> **POST** `https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/{productOrderId}/claim/exchange/collect/approve`
```
...
**POST** `/v1/pay-order/seller/product-orders/{productOrderId}/claim/exchange/collect/approve` — 응답
(성공/실패) 상품 주문 처리 내역
...
```bash
curl -L -X POST 'https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/:productOrderId/claim/exchange/collect/approve' \
