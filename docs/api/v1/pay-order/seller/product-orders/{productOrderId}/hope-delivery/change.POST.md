---
doc-id: "v1-pay-order-seller-product-orders-productOrderId-hope-delivery-change-post"
title: "배송 희망일 변경 처리"
...
```
> **POST** `https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/{productOrderId}/hope-delivery/change`
```
...
**POST** `/v1/pay-order/seller/product-orders/{productOrderId}/hope-delivery/change` — 응답
(성공/실패) 상품 주문 처리 내역
