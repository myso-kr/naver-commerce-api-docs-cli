---
doc-id: "v1-pay-order-seller-product-orders-get"
title: "조건형 상품 주문 상세 내역 조회"
...
조회 기준 유형. 생략 시 PAYED_DATETIME(결제 일시)으로 자동 지정됩니다. 250바이트 내외
...
**GET** `/v1/pay-order/seller/product-orders` — 응답
(성공) 상품 주문 내역
