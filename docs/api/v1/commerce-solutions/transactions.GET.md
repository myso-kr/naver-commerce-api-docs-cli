---
doc-id: "v1-commerce-solutions-transactions-get"
title: "비즈월렛 결제 내역 조회"
description: "paymentConfirmStartDate string<date-time>required"
type: api-endpoint
method: GET
path: /v1/commerce-solutions/transactions
...
```
> **GET** `https://api.commerce.naver.com/external/v1/commerce-solutions/transactions`
```
...
**paymentConfirmStartDate** string<date-time>required

거래 시작 일시

**Example:** 2023-08-18T00:00:00.000+09:00

**paymentConfirmEndDate** string<date-time>required

거래 종료 일시

**Example:** 2023-08-21T00:00:00.000+09:00

**transactionId** string

결제번호

**Example:** CSP230807100017M5T074S10163
...
**Possible values:** [`FREE_TRIAL`, `PAYMENT`, `UPGRADE`, `DOWNGRADE`, `REFUND`]

**planId** string

요금제 ID

**Example:** 6xyk6Ml2kDHnCi92p2DoqF
...
**GET** `/v1/commerce-solutions/transactions` — 응답
비즈월렛 결제 내역 조회 성공

**paymentConfirmDate**string<date-time>

거래 일시

**Example:** `2020-07-25T10:10:10.100+09:00`

**transactionId**string

결제번호

**Example:** `CSP230524102125M5T056S19624`
...
**Example:** `ZF75IAECnPGeZbwTPvmmN`

**solutionName**string

솔루션명

**Example:** `CLOVA 고객 맞춤 상품 추천`
...
**Example:** `ncp_2sRZTWDZ0WTrl9FDiXNnI`
...
[
  {
    "paymentConfirmDate": "2020-07-25T10:10:10.100+09:00",
    "transactionId": "CSP230524102125M5T056S19624",
    "originalTransactionId": "CSP230524102125M5T056S19624",
    "solutionId": "ZF75IAECnPGeZbwTPvmmN",
    "solutionName": "CLOVA 고객 맞춤 상품 추천",
    "transactionType": "FREE_TRIAL",
    "reason": "정기결제",
    "planId": "6xyk6Ml2kDHnCi92p2DoqF",
    "accountUid": "ncp_2sRZTWDZ0WTrl9FDiXNnI",
    "totalAmount": 0
  }
]
```
...
```bash
curl -L 'https://api.commerce.naver.com/external/v1/commerce-solutions/transactions' \
...
paymentConfirmStartDate — queryrequired

paymentConfirmEndDate — queryrequired

Show optional parameters

transactionId — query

originalTransactionId — query

solutionName — query

transactionType — query

---FREE_TRIALPAYMENTUPGRADEDOWNGRADEREFUND
