---
doc-id: "v1-commerce-solutions-subscriptions-accountUid-reject-put"
title: "사용 시작 거절"
description: "사용 시작 거절(개별 솔루션 사용에만 동작)"
type: api-endpoint
method: PUT
path: /v1/commerce-solutions/subscriptions/{accountUid}/reject
...
```
> **PUT** `https://api.commerce.naver.com/external/v1/commerce-solutions/subscriptions/{accountUid}/reject`
```

사용 시작 거절(개별 솔루션 사용에만 동작)
...
**PUT** `/v1/commerce-solutions/subscriptions/{accountUid}/reject` — 응답
사용 시작 거절 성공
...
```bash
curl -L -X PUT 'https://api.commerce.naver.com/external/v1/commerce-solutions/subscriptions/:accountUid/reject' \
