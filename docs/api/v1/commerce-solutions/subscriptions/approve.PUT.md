---
doc-id: "v1-commerce-solutions-subscriptions-approve-put"
title: "사용 시작 승인"
description: "사용 시작 승인(개별 솔루션 사용에만 동작)"
type: api-endpoint
method: PUT
path: /v1/commerce-solutions/subscriptions/approve
...
keywords:
  ...
  - "commerce-solutions subscriptions approve"
  - "approve-subscription-merchant"
  - "merchant"
  - "판매자"
  - "seller"
status: stable
updated: "2026-03-13"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/approve-subscription-merchant
---
...
```
> **PUT** `https://api.commerce.naver.com/external/v1/commerce-solutions/subscriptions/approve`
```

사용 시작 승인(개별 솔루션 사용에만 동작)
...
**PUT** `/v1/commerce-solutions/subscriptions/approve` — 응답
사용 시작 승인 성공
...
```bash
curl -L -X PUT 'https://api.commerce.naver.com/external/v1/commerce-solutions/subscriptions/approve' \
