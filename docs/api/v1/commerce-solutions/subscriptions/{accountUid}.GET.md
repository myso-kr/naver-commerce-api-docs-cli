---
doc-id: "v1-commerce-solutions-subscriptions-accountUid-get"
title: "사용 상태 조회"
description: "accountUid stringrequired"
type: api-endpoint
method: GET
path: /v1/commerce-solutions/subscriptions/{accountUid}
...
```
> **GET** `https://api.commerce.naver.com/external/v1/commerce-solutions/subscriptions/{accountUid}`
```
...
**GET** `/v1/commerce-solutions/subscriptions/{accountUid}` — 응답
사용 상태 조회 성공
...
```bash
curl -L 'https://api.commerce.naver.com/external/v1/commerce-solutions/subscriptions/:accountUid' \
