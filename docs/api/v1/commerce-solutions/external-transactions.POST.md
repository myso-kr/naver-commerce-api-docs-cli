---
doc-id: "v1-commerce-solutions-external-transactions-post"
title: "외부 개발사 자체 결제 내역 전송"
description: "transactionType거래 타입 (string)required"
type: api-endpoint
method: POST
path: /v1/commerce-solutions/external-transactions
...
```
> **POST** `https://api.commerce.naver.com/external/v1/commerce-solutions/external-transactions`
```
...
**POST** `/v1/commerce-solutions/external-transactions` — 응답
