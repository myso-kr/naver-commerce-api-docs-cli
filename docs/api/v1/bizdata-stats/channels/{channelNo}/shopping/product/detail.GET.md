---
doc-id: "v1-bizdata-stats-channels-channelNo-shopping-product-detail-get"
title: "상품별 API"
description: "[브랜드스토어 전용] 조회 기간 내 상품별 고객의 주요 행동 데이터를 PV 기준 상위 20개 제공합니다."
type: api-endpoint
method: GET
path: /v1/bizdata-stats/channels/{channelNo}/shopping/product/detail
...
```
> **GET** `https://api.commerce.naver.com/external/v1/bizdata-stats/channels/{channelNo}/shopping/product/detail`
```
...
**GET** `/v1/bizdata-stats/channels/{channelNo}/shopping/product/detail` — 응답
OK
