---
doc-id: "v1-bizdata-stats-channels-channelNo-sales-delivery-detail-get"
title: "배송 통계 API"
description: "[브랜드스토어 전용] 배송 유형별 주문량과 배송 현황 데이터를 제공합니다."
type: api-endpoint
method: GET
path: /v1/bizdata-stats/channels/{channelNo}/sales/delivery/detail
...
```
> **GET** `https://api.commerce.naver.com/external/v1/bizdata-stats/channels/{channelNo}/sales/delivery/detail`
```
...
**GET** `/v1/bizdata-stats/channels/{channelNo}/sales/delivery/detail` — 응답
OK
