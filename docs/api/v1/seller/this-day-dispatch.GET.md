---
doc-id: "v1-seller-this-day-dispatch-get"
title: "오늘출발 설정 정보 조회"
description: "오늘출발 설정 정보를 조회하는 API입니다. 조회 대상 판매자 번호에 대한 인증 토큰이 필요합니다."
type: api-endpoint
method: GET
...
keywords:
  ...
  - "get /v1/seller/this-day-dispatch"
  - "v1"
  - "this-day-dispatch"
  - "v1 seller this-day-dispatch"
  - "seller this-day-dispatch"
  - "get-today-dispatch-sellers"
  - "today"
  - "dispatch"
  - "sellers"
status: stable
updated: "2026-03-13"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/get-today-dispatch-sellers
---
...
```
> **GET** `https://api.commerce.naver.com/external/v1/seller/this-day-dispatch`
```
...
**GET** `/v1/seller/this-day-dispatch` — 응답
성공
