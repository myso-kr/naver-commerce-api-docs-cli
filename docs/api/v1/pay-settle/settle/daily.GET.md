---
doc-id: "v1-pay-settle-settle-daily-get"
title: "일별 정산 내역 조회"
...
keywords:
  ...
  - "find-daily-settle-pay-settle"
  - "find"
  - "pay"
status: stable
updated: "2026-03-13"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/find-daily-settle-pay-settle
---
...
```
> **GET** `https://api.commerce.naver.com/external/v1/pay-settle/settle/daily`
```
...
**GET** `/v1/pay-settle/settle/daily` — 응답
OK
