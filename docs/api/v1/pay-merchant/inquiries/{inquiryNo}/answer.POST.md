---
doc-id: "v1-pay-merchant-inquiries-inquiryNo-answer-post"
title: "고객 문의 답변 등록"
description: "inquiryNo integer<int64>required"
type: api-endpoint
method: POST
path: /v1/pay-merchant/inquiries/{inquiryNo}/answer
...
```
> **POST** `https://api.commerce.naver.com/external/v1/pay-merchant/inquiries/{inquiryNo}/answer`
```
...
**POST** `/v1/pay-merchant/inquiries/{inquiryNo}/answer` — 응답
OK
...
```bash
curl -L 'https://api.commerce.naver.com/external/v1/pay-merchant/inquiries/:inquiryNo/answer' \
