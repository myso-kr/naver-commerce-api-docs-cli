---
doc-id: "v1-contents-seller-notices-sellerNoticeId-put"
title: "공지사항 수정"
...
```
> **PUT** `https://api.commerce.naver.com/external/v1/contents/seller-notices/{sellerNoticeId}`
```
...
**PUT** `/v1/contents/seller-notices/{sellerNoticeId}` — 응답
성공
...
```bash
curl -L -X PUT 'https://api.commerce.naver.com/external/v1/contents/seller-notices/:sellerNoticeId' \
