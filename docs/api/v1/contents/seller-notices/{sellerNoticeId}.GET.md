---
doc-id: "v1-contents-seller-notices-sellerNoticeId-get"
title: "공지사항 단건 조회"
description: "sellerNoticeId integer<int64>required"
type: api-endpoint
method: GET
...
status: stable
updated: "2026-03-12"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/get-post-contents
---
...
```
> **GET** `https://api.commerce.naver.com/external/v1/contents/seller-notices/{sellerNoticeId}`
```
...
**GET** `/v1/contents/seller-notices/{sellerNoticeId}` — 응답
성공
...
```bash
curl -L 'https://api.commerce.naver.com/external/v1/contents/seller-notices/:sellerNoticeId' \
