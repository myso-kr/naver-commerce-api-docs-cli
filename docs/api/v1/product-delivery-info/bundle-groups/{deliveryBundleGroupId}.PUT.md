---
doc-id: "v1-product-delivery-info-bundle-groups-deliveryBundleGroupId-put"
title: "묶음배송 그룹 수정"
description: "deliveryBundleGroupId integer<int64>required"
type: api-endpoint
method: PUT
...
```
> **PUT** `https://api.commerce.naver.com/external/v1/product-delivery-info/bundle-groups/{deliveryBundleGroupId}`
```
...
**PUT** `/v1/product-delivery-info/bundle-groups/{deliveryBundleGroupId}` — 응답
성공
