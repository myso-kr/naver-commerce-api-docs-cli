---
doc-id: "v1-product-delivery-info-bundle-groups-deliveryBundleGroupId-get"
title: "묶음배송 그룹 단건 조회"
description: "묶음배송 그룹 정보를 조회합니다."
type: api-endpoint
method: GET
path: /v1/product-delivery-info/bundle-groups/{deliveryBundleGroupId}
...
```
> **GET** `https://api.commerce.naver.com/external/v1/product-delivery-info/bundle-groups/{deliveryBundleGroupId}`
```
...
**GET** `/v1/product-delivery-info/bundle-groups/{deliveryBundleGroupId}` — 응답
성공

**deliveryBundleGroup** 묶음배송 그룹 정보 구조체 (object)
...
```bash
curl -L 'https://api.commerce.naver.com/external/v1/product-delivery-info/bundle-groups/:deliveryBundleGroupId' \
