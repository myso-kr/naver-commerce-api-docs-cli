---
doc-id: "v1-product-delivery-info-hope-delivery-groups-get"
title: "희망일배송 그룹 다건 조회"
description: "희망일배송 그룹 목록을 조회합니다."
type: api-endpoint
method: GET
...
keywords:
  ...
  - "get /v1/product-delivery-info/hope-delivery-groups"
  - "v1"
  ...
  - "get-hope-delivery-group-list-product"
  - "hope"
  - "delivery"
  - "배송"
  - "logistics"
...
status: stable
updated: "2026-03-13"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/get-hope-delivery-group-list-product
---
...
```
> **GET** `https://api.commerce.naver.com/external/v1/product-delivery-info/hope-delivery-groups`
```
...
**GET** `/v1/product-delivery-info/hope-delivery-groups` — 응답
성공
