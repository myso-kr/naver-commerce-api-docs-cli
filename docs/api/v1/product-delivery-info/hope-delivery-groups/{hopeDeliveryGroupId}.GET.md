---
doc-id: "v1-product-delivery-info-hope-delivery-groups-hopeDeliveryGroupId-get"
title: "희망일배송 그룹 단건 조회"
description: "희망일배송 그룹 정보를 조회합니다."
type: api-endpoint
method: GET
path: /v1/product-delivery-info/hope-delivery-groups/{hopeDeliveryGroupId}
...
```
> **GET** `https://api.commerce.naver.com/external/v1/product-delivery-info/hope-delivery-groups/{hopeDeliveryGroupId}`
```
...
**hopeDeliveryGroupId** integer<int64>required

희망일배송 그룹 ID

## Responses

**GET** `/v1/product-delivery-info/hope-delivery-groups/{hopeDeliveryGroupId}` — 응답
성공

**hopeDeliveryGroup** 희망일배송 그룹 정보 구조체 (object)
...
```bash
curl -L 'https://api.commerce.naver.com/external/v1/product-delivery-info/hope-delivery-groups/:hopeDeliveryGroupId' \
...
hopeDeliveryGroupId — pathrequired
