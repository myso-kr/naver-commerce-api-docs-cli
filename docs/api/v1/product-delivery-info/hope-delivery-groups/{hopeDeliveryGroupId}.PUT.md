---
doc-id: "v1-product-delivery-info-hope-delivery-groups-hopeDeliveryGroupId-put"
title: "희망일배송 그룹 수정"
description: "hopeDeliveryGroupId integer<int64>required"
type: api-endpoint
method: PUT
...
```
> **PUT** `https://api.commerce.naver.com/external/v1/product-delivery-info/hope-delivery-groups/{hopeDeliveryGroupId}`
```
...
**PUT** `/v1/product-delivery-info/hope-delivery-groups/{hopeDeliveryGroupId}` — 응답
성공
...
```bash
curl -L -X PUT 'https://api.commerce.naver.com/external/v1/product-delivery-info/hope-delivery-groups/:hopeDeliveryGroupId' \
