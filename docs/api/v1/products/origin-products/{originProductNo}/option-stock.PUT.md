---
doc-id: "v1-products-origin-products-originProductNo-option-stock-put"
title: "상품 옵션 재고 변경"
description: "상품 옵션의 재고, 가격, 할인가를 변경합니다."
type: api-endpoint
method: PUT
...
```
> **PUT** `https://api.commerce.naver.com/external/v1/products/origin-products/{originProductNo}/option-stock`
```
...
**PUT** `/v1/products/origin-products/{originProductNo}/option-stock` — 응답
성공
