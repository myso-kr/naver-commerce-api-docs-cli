---
doc-id: "v1-customer-data-customer-status-channels-channelNo-statistics-get"
title: "고객 현황(채널) API"
description: "[브랜드스토어 전용] 채널의 일별 고객 현황 데이터를 제공합니다."
type: api-endpoint
method: GET
path: /v1/customer-data/customer-status/channels/{channelNo}/statistics
...
```
> **GET** `https://api.commerce.naver.com/external/v1/customer-data/customer-status/channels/{channelNo}/statistics`
```

[브랜드스토어 전용] 채널의 일별 고객 현황 데이터를 제공합니다.
...
**channelNo** integer<int64>required
...
**GET** `/v1/customer-data/customer-status/channels/{channelNo}/statistics` — 응답
OK
...
```bash
curl -L 'https://api.commerce.naver.com/external/v1/customer-data/customer-status/channels/:channelNo/statistics' \
