---
doc-id: "v1-customer-data-customer-status-account-statistics-get"
title: "고객 현황(계정) API"
description: "[브랜드스토어 전용] 스토어의 일별 고객 현황 데이터를 제공합니다."
type: api-endpoint
method: GET
path: /v1/customer-data/customer-status/account/statistics
...
keywords:
  ...
  - "v1 customer-data customer-status account statistics"
  - "account statistics"
  - "customer-data customer-status account statistics"
  - "get-account-customer-status-data-insight"
  - "customer"
  - "status"
  - "data"
  - "insight"
...
```
> **GET** `https://api.commerce.naver.com/external/v1/customer-data/customer-status/account/statistics`
```
...
**GET** `/v1/customer-data/customer-status/account/statistics` — 응답
OK
