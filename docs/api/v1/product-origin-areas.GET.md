---
doc-id: "v1-product-origin-areas-get"
title: "원산지 코드 정보 전체 조회"
description: "원산지 코드 전체를 조회합니다."
type: api-endpoint
method: GET
path: /v1/product-origin-areas
...
```
> **GET** `https://api.commerce.naver.com/external/v1/product-origin-areas`
```
...
**GET** `/v1/product-origin-areas` — 응답
성공
