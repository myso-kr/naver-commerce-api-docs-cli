---
doc-id: "v1-logistics-products-sellers-me-skus-query-paged-list-post"
title: "SKU 목록 조회 API"
description: "SKU 목록 페이지를 조회합니다."
type: api-endpoint
method: POST
...
keywords:
  ...
  - "query-paged-list"
  - "v1 logistics products sellers me skus query-paged-list"
  - "skus query-paged-list"
  - "logistics products sellers me skus query-paged-list"
  - "get-ns-information-paged-list-nfa"
  - "get"
  - "ns"
  - "information"
  - "paged"
...
status: stable
updated: "2026-03-13"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/get-ns-information-paged-list-nfa
---
...
```
> **POST** `https://api.commerce.naver.com/external/v1/logistics/products/sellers/me/skus/query-paged-list`
```
...
- 조회하고자 하는 날짜 기준
- SKU_REG_DAY 선택 시, SKU 등록일을 입력합니다.
- SKU_MOD_DAY 선택 시, SKU 수정일을 입력합니다.
...
**POST** `/v1/logistics/products/sellers/me/skus/query-paged-list` — 응답
OK
