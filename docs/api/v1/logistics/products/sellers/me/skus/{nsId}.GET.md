---
doc-id: "v1-logistics-products-sellers-me-skus-nsId-get"
title: "SKU 조회 API"
description: "호출 대상 네이버 SKU ID에 대한 상세 정보를 응답합니다."
type: api-endpoint
method: GET
...
```
> **GET** `https://api.commerce.naver.com/external/v1/logistics/products/sellers/me/skus/{nsId}`
```
...
**GET** `/v1/logistics/products/sellers/me/skus/{nsId}` — 응답
OK
