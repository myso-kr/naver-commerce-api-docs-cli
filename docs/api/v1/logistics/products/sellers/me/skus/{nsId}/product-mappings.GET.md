---
doc-id: "v1-logistics-products-sellers-me-skus-nsId-product-mappings-get"
title: "SKU 연결상품 조회 API"
description: "SKU에 연결된 상품 목록을 페이지 단위로 조회합니다."
type: api-endpoint
method: GET
...
keywords:
  ...
  - "product-mapping"
  - "v1 logistics products sellers me skus nsid product-mappings"
  - "nsid product-mappings"
  - "logistics products sellers me skus nsid product-mappings"
  - "get-linked-products-nfa"
  - "linked"
status: stable
updated: "2026-03-13"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/get-linked-products-nfa
---
...
```
> **GET** `https://api.commerce.naver.com/external/v1/logistics/products/sellers/me/skus/{nsId}/product-mappings`
```
...
**GET** `/v1/logistics/products/sellers/me/skus/{nsId}/product-mappings` — 응답
OK
