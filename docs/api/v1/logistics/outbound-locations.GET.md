---
doc-id: "v1-logistics-outbound-locations-get"
title: "판매자 창고 정보 조회"
description: "판매자 계정이 운영 중인 창고에 대한 창고 ID, 창고명, 택배사, 배송 속성을 조회합니다."
type: api-endpoint
method: GET
...
```
> **GET** `https://api.commerce.naver.com/external/v1/logistics/outbound-locations`
```
...
**GET** `/v1/logistics/outbound-locations` — 응답
OK
