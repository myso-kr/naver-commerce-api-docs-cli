---
doc-id: "schema-묶음배송-그룹-정보-구조체"
title: "묶음배송 그룹 정보 구조체"
description: "묶음배송 그룹 정보 이 구조체는 상품의 배송 정보 중 묶음배송 그룹 정보 데이터를 표현하는 구조체입니다."
type: schema
category: 물류
tags:
  - logistics
...
status: stable
updated: "2026-03-12"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/schemas/묶음배송-그룹-정보-구조체
---
