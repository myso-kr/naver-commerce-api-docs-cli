---
doc-id: "schema-원상품-정보-구조체"
title: "원상품 정보 구조체"
description: "응답용 상품 속성. 원상품에 속한 채널 상품은 모두 상품 공통 속성을 참고합니다. 이 구조체는 상품 정보 중 원상품 속성에 해당하는 상품 데이터를 표현하는 구조체입니다."
type: schema
category: 상품
tags:
  - product
...
해당 카탈로그 ID 기준으로 [카탈로그 단건 조회](../api/v1/product-models/{id}.GET.md)에서 상세 정보를 조회할 수 있습니다.
