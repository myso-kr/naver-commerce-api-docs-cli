---
doc-id: "schema-상품-문의-내용-구조체"
title: "상품 문의 내용 구조체"
description: "상품 문의 목록 응답 이 구조체는 대상 상품의 상세 페이지에서 상품Q&A로 남겨진 상품 문의 내용 데이터를 표현하는 구조체입니다."
type: schema
category: 문의
tags:
  - inquiry
...
status: stable
updated: "2026-03-12"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/schemas/상품-문의-내용-구조체
---
