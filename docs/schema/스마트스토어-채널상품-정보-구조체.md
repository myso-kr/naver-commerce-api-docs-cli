---
doc-id: "schema-스마트스토어-채널상품-정보-구조체"
title: "스마트스토어 채널상품 정보 구조체"
description: "이 구조체는 상품 정보 중 스마트스토어 채널상품 속성에 해당하는 상품 데이터를 표현하는 구조체입니다."
type: schema
category: 상품
tags:
  - product
...
status: stable
updated: "2026-03-12"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/schemas/스마트스토어-채널상품-정보-구조체
---
