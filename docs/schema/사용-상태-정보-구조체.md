---
doc-id: "schema-사용-상태-정보-구조체"
title: "사용 상태 정보 구조체"
description: "사용 현황 응답 데이터 이 구조체는 대상 사용자의 솔루션 사용 상태 정보를 표현하는 구조체입니다."
type: schema
category: 기타
tags:
  - reference
...
status: stable
updated: "2026-03-12"
source: https://apicenter.commerce.naver.com/docs/commerce-api/current/schemas/사용-상태-정보-구조체
---
