...
> 원문: https://apicenter.commerce.naver.com/docs/commerce-api/current/update-channel-product-product
...
**smartstoreChannelProduct** 스마트스토어 채널상품 정보 구조체 (object)
...
```bash
curl -L -X PUT 'https://api.commerce.naver.com/external/v2/products/channel-products/:channelProductNo' \
