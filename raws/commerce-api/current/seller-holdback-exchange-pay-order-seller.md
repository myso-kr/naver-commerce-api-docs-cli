...
> 원문: https://apicenter.commerce.naver.com/docs/commerce-api/current/seller-holdback-exchange-pay-order-seller
...
**holdbackExchangeDetailReason**stringrequired
...
```bash
curl -L 'https://api.commerce.naver.com/external/v1/pay-order/seller/product-orders/:productOrderId/claim/exchange/holdback' \
-H 'Content-Type: application/json' \
-H 'Accept: application/json' \
-H 'Authorization: Bearer <token>' \
-d '{
  "holdbackClassType": "string",
  "holdbackExchangeDetailReason": "미입고 상태",
